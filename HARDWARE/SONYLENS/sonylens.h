...
#else
#define SONY_ZOOM_RATIO_1X (0x0000)
#define SONY_ZOOM_RATIO_2X (0x16A1)
#define SONY_ZOOM_RATIO_3X (0x2063)
#define SONY_ZOOM_RATIO_4X (0x2628)
#define SONY_ZOOM_RATIO_5X (0x2a1d)
#define SONY_ZOOM_RATIO_6X (0x2d13)
#define SONY_ZOOM_RATIO_7X (0x2f6d)
#define SONY_ZOOM_RATIO_8X (0x3161)
#define SONY_ZOOM_RATIO_9X (0x330D)
#define SONY_ZOOM_RATIO_10X (0x3486)
#define SONY_ZOOM_RATIO_11X (0x35d7)
#define SONY_ZOOM_RATIO_12X (0x3709)
#define SONY_ZOOM_RATIO_13X (0x3820)
#define SONY_ZOOM_RATIO_14X (0x3920)
#define SONY_ZOOM_RATIO_15X (0x3a0a)
#define SONY_ZOOM_RATIO_16X (0x3add)
#define SONY_ZOOM_RATIO_17X (0x3b9c)
#define SONY_ZOOM_RATIO_18X (0x3c46)
#define SONY_ZOOM_RATIO_19X (0x3cdc)
#define SONY_ZOOM_RATIO_20X (0x3d60)
#define SONY_ZOOM_RATIO_21X (0x3dd4)
#define SONY_ZOOM_RATIO_22X (0x3e39)
#define SONY_ZOOM_RATIO_23X (0x3e90)
#define SONY_ZOOM_RATIO_24X (0x3edc)
#define SONY_ZOOM_RATIO_25X (0x3f1e)
#define SONY_ZOOM_RATIO_26X (0x3f57)
#define SONY_ZOOM_RATIO_27X (0x3f8a)
#define SONY_ZOOM_RATIO_28X (0x3fb6)
#define SONY_ZOOM_RATIO_29X (0x3fdc)
#define SONY_ZOOM_RATIO_30X (0x4000)
#endif
